...
// Alias definitions for missing Johto trainer graphics pics & classes
#define TRAINER_PIC_PETREL            TRAINER_PIC_AQUA_GRUNT_M
#define TRAINER_PIC_PROTON            TRAINER_PIC_AQUA_GRUNT_M
#define TRAINER_PIC_LEADER_PRYCE      TRAINER_PIC_EXPERT_M
#define TRAINER_CLASS_BURGLAR         TRAINER_CLASS_BURGLAR_FRLG
#define TRAINER_PIC_BURGLAR           TRAINER_PIC_BURGLAR_FRLG
#define TRAINER_PIC_SILVER            TRAINER_PIC_RED
#define TRAINER_PIC_LEADER_WHITNEY    TRAINER_PIC_LEADER_WINONA
#define TRAINER_CLASS_ROCKET_ADMIN    TRAINER_CLASS_BOSS_FRLG
#define TRAINER_PIC_ARCHER            TRAINER_PIC_AQUA_ADMIN_M
#define TRAINER_PIC_ARIANA            TRAINER_PIC_AQUA_ADMIN_F
#define TRAINER_CLASS_FIREBREATHER    TRAINER_CLASS_KINDLER
#define TRAINER_PIC_FIREBREATHER      TRAINER_PIC_KINDLER
#define TRAINER_PIC_LEADER_BUGSY      TRAINER_PIC_LEADER_BRAWLY
#define TRAINER_CLASS_SAGE            TRAINER_CLASS_EXPERT
#define TRAINER_PIC_SAGE              TRAINER_PIC_EXPERT_M
#define TRAINER_PIC_LEADER_CHUCK      TRAINER_PIC_BLACK_BELT
#define TRAINER_PIC_LEADER_CLAIR      TRAINER_PIC_COOLTRAINER_F
#define TRAINER_CLASS_POLICEMAN       TRAINER_CLASS_SAILOR
#define TRAINER_PIC_POLICEMAN         TRAINER_PIC_SAILOR
#define TRAINER_CLASS_TEAM_ROCKET     TRAINER_CLASS_TEAM_ROCKET_FRLG
#define TRAINER_PIC_ROCKET_GRUNT_M    TRAINER_PIC_ROCKET_GRUNT_M_FRLG
#define TRAINER_PIC_ROCKET_GRUNT_F    TRAINER_PIC_ROCKET_GRUNT_F_FRLG
#define TRAINER_CLASS_MYSTERY_MAN     TRAINER_CLASS_COOLTRAINER
#define TRAINER_PIC_EUSINE            TRAINER_PIC_STEVEN
#define TRAINER_PIC_LEADER_FALKNER    TRAINER_PIC_BIRD_KEEPER
#define TRAINER_CLASS_JUGGLER         TRAINER_CLASS_RUIN_MANIAC
#define TRAINER_PIC_JUGGLER           TRAINER_PIC_RUIN_MANIAC
#define TRAINER_PIC_LEADER_JASMINE    TRAINER_PIC_LEADER_ROXANNE
#define TRAINER_CLASS_KIMONO_GIRL     TRAINER_CLASS_BEAUTY
#define TRAINER_PIC_KIMONO_GIRL       TRAINER_PIC_BEAUTY
#define TRAINER_PIC_MR_FUJI           TRAINER_PIC_OLD_MAN
#define TRAINER_CLASS_SUPER_NERD      TRAINER_CLASS_SUPER_NERD_FRLG
#define TRAINER_PIC_SUPER_NERD        TRAINER_PIC_SUPER_NERD_FRLG
#define TRAINER_PIC_LEADER_MORTY      TRAINER_PIC_GUITARIST
#define TRAINER_CLASS_PSYCHIC_M       TRAINER_CLASS_PSYCHIC
