...
enum
{
    ...
    OBJ_EVENT_GFX_GOLD_NORMAL, // Johto protagonist (male) — placeholder uses Red sprites until real art is added
    OBJ_EVENT_GFX_GOLD_BIKE,
    OBJ_EVENT_GFX_GOLD_SURF,
    OBJ_EVENT_GFX_GOLD_FIELD_MOVE,
    OBJ_EVENT_GFX_GOLD_FISH,
    OBJ_EVENT_GFX_GOLD_VS_SEEKER,
    OBJ_EVENT_GFX_GOLD_VS_SEEKER_BIKE,
    OBJ_EVENT_GFX_KRIS_NORMAL, // Johto protagonist (female) — placeholder uses Leaf sprites until real art is added
    OBJ_EVENT_GFX_KRIS_BIKE,
    OBJ_EVENT_GFX_KRIS_SURF,
    OBJ_EVENT_GFX_KRIS_FIELD_MOVE,
    OBJ_EVENT_GFX_KRIS_FISH,
    OBJ_EVENT_GFX_KRIS_VS_SEEKER,
    OBJ_EVENT_GFX_KRIS_VS_SEEKER_BIKE,
    NUM_OBJ_EVENT_GFX,
};
...
// Johto NPC sprite placeholders — reuse existing sprites until proper HGSS sprites are added
#define OBJ_EVENT_GFX_SILVER            OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL
#define OBJ_EVENT_GFX_EUSINE            OBJ_EVENT_GFX_SCIENTIST_1
#define OBJ_EVENT_GFX_KIMONO_GIRL       OBJ_EVENT_GFX_LASS
#define OBJ_EVENT_GFX_KURT              OBJ_EVENT_GFX_OLD_MAN
#define OBJ_EVENT_GFX_PROF_ELM         OBJ_EVENT_GFX_SCIENTIST_1
#define OBJ_EVENT_GFX_JASMINE           OBJ_EVENT_GFX_LASS
#define OBJ_EVENT_GFX_MORTY             OBJ_EVENT_GFX_YOUNGSTER
#define OBJ_EVENT_GFX_BUGSY             OBJ_EVENT_GFX_BUG_CATCHER
#define OBJ_EVENT_GFX_FALKNER           OBJ_EVENT_GFX_YOUNGSTER
#define OBJ_EVENT_GFX_CHUCK             OBJ_EVENT_GFX_BLACK_BELT
#define OBJ_EVENT_GFX_PRYCE             OBJ_EVENT_GFX_OLD_MAN
#define OBJ_EVENT_GFX_CLAIR             OBJ_EVENT_GFX_BEAUTY
#define OBJ_EVENT_GFX_WHITNEY           OBJ_EVENT_GFX_LASS
// Placeholder sprites for Johto Team Rocket executives (no proper sprites yet)
#define OBJ_EVENT_GFX_TEAM_AQUA_ADMIN          OBJ_EVENT_GFX_AQUA_MEMBER_M
#define OBJ_EVENT_GFX_TEAM_AQUA_ADMIN_FEMALE   OBJ_EVENT_GFX_AQUA_MEMBER_F
#define OBJ_EVENT_GFX_TEAM_AQUA_MEMBER_MALE    OBJ_EVENT_GFX_AQUA_MEMBER_M
#define OBJ_EVENT_GFX_ARCHER            OBJ_EVENT_GFX_TEAM_AQUA_ADMIN
#define OBJ_EVENT_GFX_ARIANA            OBJ_EVENT_GFX_TEAM_AQUA_ADMIN_FEMALE
#define OBJ_EVENT_GFX_PETREL            OBJ_EVENT_GFX_TEAM_AQUA_MEMBER_MALE
#define OBJ_EVENT_GFX_PROTON            OBJ_EVENT_GFX_TEAM_AQUA_MEMBER_MALE
#define OBJ_EVENT_GFX_ENGINEER          OBJ_EVENT_GFX_EXPERT_M
#define OBJ_EVENT_GFX_ATTENDANT         OBJ_EVENT_GFX_LASS
#define OBJ_EVENT_GFX_ATTENDANT_M       OBJ_EVENT_GFX_YOUNGSTER
#define OBJ_EVENT_GFX_SAGE              OBJ_EVENT_GFX_OLD_MAN_2
#define OBJ_EVENT_GFX_JUGGLER           OBJ_EVENT_GFX_YOUNGSTER
#define OBJ_EVENT_GFX_FIREBREATHER      OBJ_EVENT_GFX_MANIAC
#define OBJ_EVENT_GFX_BURGLAR           OBJ_EVENT_GFX_MANIAC
#define OBJ_EVENT_GFX_SUPER_NERD        OBJ_EVENT_GFX_SCIENTIST_1
// Placeholder sprites for missing FRLG/Johto graphics
#define OBJ_EVENT_GFX_BATTLE_GIRL_FRLG  OBJ_EVENT_GFX_CRUSH_GIRL
#define OBJ_EVENT_GFX_SCHOOL_KID_F      OBJ_EVENT_GFX_LITTLE_GIRL_FRLG
#define OBJ_EVENT_GFX_HO_OH             OBJ_EVENT_GFX_HOOH
#define OBJ_EVENT_GFX_GYARADOS          OBJ_EVENT_GFX_LAPRAS
#define OBJ_EVENT_GFX_BATTLE_GIRL       OBJ_EVENT_GFX_BATTLE_GIRL_FRLG
#define OBJ_EVENT_GFX_SCIENTIST_M       OBJ_EVENT_GFX_SCIENTIST_1
#define OBJ_EVENT_GFX_SCIENTIST_F       OBJ_EVENT_GFX_SCHOOL_KID_F
#define OBJ_EVENT_GFX_NURSE_CHANSEY     OBJ_EVENT_GFX_NURSE_FRLG
#define OBJ_EVENT_GFX_SLOWPOKE_NO_TAIL  OBJ_EVENT_GFX_SLOWPOKE
#define OBJ_EVENT_GFX_LEGENDARY_SHADOW  OBJ_EVENT_GFX_HO_OH
#define OBJ_EVENT_GFX_SHINY_GYARADOS    OBJ_EVENT_GFX_GYARADOS
#define OBJ_EVENT_GFX_MON_BASE          OBJ_EVENT_GFX_PIKACHU
#define OBJ_EVENT_GFX_WHIRLPOOL         OBJ_EVENT_GFX_SUDOWOODO
#define OBJ_EVENT_GFX_TRAIN_FRONT       OBJ_EVENT_GFX_SS_ANNE
...
#define OBJ_EVENT_PAL_TAG_PLAYER_GOLD             0x1128  // Johto male — shares FRLG palette until real art added
#define OBJ_EVENT_PAL_TAG_PLAYER_KRIS             0x1129  // Johto female — shares FRLG palette until real art added
