...
// HGSS music (ported from Pokémon Heart & Soul)
...
#define MUS_HG_HALL_OF_FAME                 617 // The Hall of Fame
...
#define MUS_HG_VERMILION                    632 // Vermilion City (HGSS version)
#define MUS_HG_PEWTER                       633 // Pewter City (HGSS version)
#define MUS_HG_CERULEAN                     634 // Cerulean City (HGSS version)
#define MUS_HG_LAVENDER                     635 // Lavender Town (HGSS version)
#define MUS_HG_CELADON                      636 // Celadon City (HGSS version)
#define MUS_HG_PALLET                       637 // Pallet Town (HGSS version)
#define MUS_HG_CINNABAR                     638 // Cinnabar Island (HGSS version)
#define MUS_HG_ROUTE1                       639 // Route 1 (HGSS version)
#define MUS_HG_ROUTE3                       640 // Route 3 (HGSS version)
#define MUS_HG_ROUTE11                      641 // Route 11 (HGSS version)
#define MUS_HG_ROUTE24                      642 // Route 24 (HGSS version)
#define MUS_HG_ROUTE26                      643 // Route 26 (HGSS version)
...
#define MUS_HG_VS_WILD                      696 // Battle! (Wild Pokémon - Johto)
#define MUS_HG_VS_TRAINER                   697 // Battle! (Trainer Battle - Johto)
#define MUS_HG_VS_GYM_LEADER                698 // Battle! (Gym Leader - Johto)
...
#define MUS_HG_VS_WILD_KANTO                705 // Battle! (Wild Pokémon - Kanto, HGSS)
#define MUS_HG_VS_TRAINER_KANTO             706 // Battle! (Trainer Battle - Kanto, HGSS)
#define MUS_HG_VS_GYM_LEADER_KANTO          707 // Battle! (Gym Leader - Kanto, HGSS)
...
#define MUS_HG_B_FACTORY                    722 // Battle Factory (Johto)
#define MUS_HG_B_HALL                       723 // Battle Hall
#define MUS_HG_B_ARCADE                     724 // Battle Arcade
#define MUS_HG_B_CASTLE                     725 // Battle Castle
#define MUS_HG_VS_FRONTIER_BRAIN            726 // Battle! (Frontier Brain, HGSS)
#define MUS_HG_VICTORY_FRONTIER_BRAIN       727 // Victory! (Frontier Brain, HGSS)
...
#define MUS_HG_VS_KYOGRE_GROUDON            752 // Battle! (Super-Ancient Pokémon, HGSS)
...
#define MUS_HG_CARD_FLIP                    775 // Voltorb Flip
...
#define MUS_HG_OBTAIN_ARCADE_POINTS         782 // Received Battle Points (Battle Arcade)
