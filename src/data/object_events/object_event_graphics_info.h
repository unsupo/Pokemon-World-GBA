...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldNormal = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_GOLD,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    .width = 16,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldBike = {
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_GoldBike,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldSurf = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_GOLD,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldFieldMove = {
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_FieldMove,
    .images = sPicTable_GoldItem,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldFish = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_GOLD,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_Fishing,
    .images = sPicTable_GoldFish,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldVSSeeker = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_GOLD,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 256,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GoldVSSeekerBike = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_GOLD,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_RedGreenVSSeekerBike,
    .images = sPicTable_GoldVSSeekerBike,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_KrisNormal = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_KRIS,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    .width = 16,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_KrisVSSeekerBike = {
    ...
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_RedGreenVSSeekerBike,
    .images = sPicTable_KrisVSSeekerBike,
    .affineAnims = gDummySpriteAffineAnimTable,
};
