...
static const u16 sFRLGPlayerAvatarGfxIds[][GENDER_COUNT] =
{
...
static const u16 sJohtoPlayerAvatarGfxIds[][GENDER_COUNT] =
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_GOLD_NORMAL,     OBJ_EVENT_GFX_KRIS_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_GOLD_BIKE,       OBJ_EVENT_GFX_KRIS_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_GOLD_BIKE,       OBJ_EVENT_GFX_KRIS_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_GOLD_SURF,       OBJ_EVENT_GFX_KRIS_SURF},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_GOLD_SURF,       OBJ_EVENT_GFX_KRIS_SURF},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_GOLD_FIELD_MOVE, OBJ_EVENT_GFX_KRIS_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_GOLD_FISH,       OBJ_EVENT_GFX_KRIS_FISH},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_GOLD_FIELD_MOVE, OBJ_EVENT_GFX_KRIS_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_GOLD_VS_SEEKER,  OBJ_EVENT_GFX_KRIS_VS_SEEKER},
};
...
{
    switch (VarGet(VAR_AVATAR_STYLE))
    {
    case AVATAR_STYLE_KANTO:
        return sFRLGPlayerAvatarGfxIds[state][gender];
    case AVATAR_STYLE_JOHTO:
        return sJohtoPlayerAvatarGfxIds[state][gender];
    default:
...
enum Gender GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_KRIS_SURF:
    case OBJ_EVENT_GFX_KRIS_FIELD_MOVE:
    case OBJ_EVENT_GFX_KRIS_FISH:
    case OBJ_EVENT_GFX_KRIS_VS_SEEKER:
    case OBJ_EVENT_GFX_KRIS_VS_SEEKER_BIKE:
        return FEMALE;
    default:
        return MALE;
    }
